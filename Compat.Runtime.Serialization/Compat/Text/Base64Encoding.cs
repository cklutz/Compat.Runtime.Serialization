...
namespace Compat.Text
{
    internal class Base64Encoding : Encoding
    {
        ...
        public override int GetMaxByteCount(int charCount)
        {
            ...
            if ((charCount % 4) != 0)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRHelper.Format(SR.XmlInvalidBase64Length, charCount.ToString(NumberFormatInfo.CurrentInfo))));
            }
        ...
        public override unsafe int GetByteCount(char[] chars, int index, int count)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(index), SRHelper.Format(SR.OffsetExceedsBufferSize, chars.Length)));
            }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(count), SRHelper.Format(SR.SizeExceedsRemainingBufferSpace, chars.Length - index)));
            }
            ...
            if ((count % 4) != 0)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRHelper.Format(SR.XmlInvalidBase64Length, count.ToString(NumberFormatInfo.CurrentInfo))));
            }
            ...
            fixed (byte* _char2val = char2val)
            {
                fixed (char* _chars = &chars[index])
                {
                    ...
                    while (pch < pchMax)
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRHelper.Format(SR.XmlInvalidBase64Sequence, new string(pch, 0, 4), index + (int)(pch - _chars))));
                        }
        ...
        public override unsafe int GetBytes(char[] chars, int charIndex, int charCount, byte[] bytes, int byteIndex)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(charIndex), SRHelper.Format(SR.OffsetExceedsBufferSize, chars.Length)));
            }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(charCount), SRHelper.Format(SR.SizeExceedsRemainingBufferSpace, chars.Length - charIndex)));
            }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(byteIndex), SRHelper.Format(SR.OffsetExceedsBufferSize, bytes.Length)));
            }
                ...
                fixed (char* _chars = &chars[charIndex])
                {
                    fixed (byte* _bytes = &bytes[byteIndex])
                    {
                        ...
                        while (pch < pchMax)
                        {
                            ...
                            if ((pch0 | pch1 | pch2 | pch3) >= 128)
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRHelper.Format(SR.XmlInvalidBase64Sequence, new string(pch, 0, 4), charIndex + (int)(pch - _chars))));
                            }
                            // xx765432 xx107654 xx321076 xx543210
                            // 76543210 76543210 76543210
                ...
                fixed (byte* _chars = &chars[charIndex])
                {
                    fixed (byte* _bytes = &bytes[byteIndex])
                    {
                        ...
                        while (pch < pchMax)
                        {
                            ...
                            if ((pch0 | pch1 | pch2 | pch3) >= 128)
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRHelper.Format(SR.XmlInvalidBase64Sequence, new string((sbyte*)pch, 0, 4), charIndex + (int)(pch - _chars))));
                            }
                            // xx765432 xx107654 xx321076 xx543210
                            // 76543210 76543210 76543210
        ...
        public override int GetMaxCharCount(int byteCount)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(byteCount), SRHelper.Format(SR.ValueMustBeInRange, 0, int.MaxValue / 4 * 3 - 2)));
            }
        ...
        public override unsafe int GetChars(byte[] bytes, int byteIndex, int byteCount, char[] chars, int charIndex)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(byteCount), SRHelper.Format(SR.SizeExceedsRemainingBufferSpace, bytes.Length - byteIndex)));
            }
