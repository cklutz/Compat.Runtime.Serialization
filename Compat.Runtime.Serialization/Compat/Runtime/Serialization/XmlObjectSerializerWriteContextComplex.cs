    ...
    internal class XmlObjectSerializerWriteContextComplex : XmlObjectSerializerWriteContext
    {
        ...
        internal override DataContract GetDataContract(RuntimeTypeHandle typeHandle, Type type)
        {
            ...
            if (dataContract != null)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidDataContractException(SRHelper.Format(SR.SurrogatesWithGetOnlyCollectionsNotSupportedSerDeser,
        ...
        internal override void CheckIfTypeSerializable(Type memberType, bool isMemberTypeSerializable)
        {
            ...
            else
            {
                if (dataContractSurrogate != null)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidDataContractException(SRHelper.Format(SR.TypeNotSerializable, memberType)));
                    }
