        ...
        public void Export(ICollection<Assembly> assemblies)
        {
            ...
            try
            {
                foreach (Assembly assembly in assemblies)
                {
                    if (assembly == null)
                    {
                        throw Compat.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRHelper.Format(SR.CannotExportNullAssembly, "assemblies")));
                    }
        ...
        public void Export(ICollection<Type> types)
        {
            ...
            try
            {
                foreach (Type type in types)
                {
                    if (type == null)
                    {
                        throw Compat.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRHelper.Format(SR.CannotExportNullType, nameof(types))));
                    }
        ...
        public bool CanExport(ICollection<Assembly> assemblies)
        {
            ...
            try
            {
                foreach (Assembly assembly in assemblies)
                {
                    if (assembly == null)
                    {
                        throw Compat.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRHelper.Format(SR.CannotExportNullAssembly, nameof(assemblies))));
                    }
