...
namespace Compat.Runtime.Serialization
{
    internal class Attributes
    {
        ...
        private void ReadId(XmlReaderDelegator reader)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer.CreateSerializationException(SRHelper.Format(SR.InvalidXsIdDefinition, Id)));
            }
        }
        ...
        private void ReadRef(XmlReaderDelegator reader)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer.CreateSerializationException(SRHelper.Format(SR.InvalidXsRefDefinition, Ref)));
            }
        }
        ...
        private void ReadArraySize(XmlReaderDelegator reader)
        {
            ...
            if (ArraySZSize < 0)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer.CreateSerializationException(SRHelper.Format(SR.InvalidSizeDefinition, ArraySZSize)));
            }
        }
